"""
Django settings for maddies_site project.
...
ROOT_URLCONF = 'maddies_site.urls'
...
WSGI_APPLICATION = 'maddies_site.wsgi.application'
...
MEDIA_URL = '/media/'
if node() == 'intellidev':
    MEDIA_ROOT = '/home/iddesigns/media'
    STATIC_ROOT = '/home/iddesigns/media/'
else:
